...
#define LCD_PULSE_TIME 50
#define SEG_PULSE_TIME 250
...
void LCDClearSection(byte x, byte y); // clears a cell in the lcd given the coordinates


//LCDClearSection(1, 5, 10);  // This will clear characters from column 5 to 10 on row 1
...
void LCDClearSection(byte x, byte y) {
    LCDGoto(x, y);
    LCDDat(32);
    //LCDStr(' ');
}
